/**
 * Creates an SVG standard badge with a single section, displaying text inside the badge.
 * The colors and text content can be customized by providing appropriate parameters.
 *
 * @param {string} text - The text to be displayed inside the badge.
 * @param {string} textColor - The color of the text inside the badge in hexadecimal format (#RRGGBB).
 * @param {string} badgeColor - The color of the badge in hexadecimal format (#RRGGBB).
 * @param {string} [fontWeight="normal"] - The font weight of the text inside the badge. Use values like "normal" or "bold".
 * @param {boolean} [roundCornerQuery=false] - If true, the badge will have rounded corners.
 * @returns {string} The SVG code representing the standard badge.
 */
